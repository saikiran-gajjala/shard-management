...
export class HomeComponent implements OnInit {
    ...
    this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        this.shardManagerService
          .shardDatabase(this.selectedDatabase.database)
          .subscribe(
            (result: boolean) => {
              this.spinner.hide();
              this.fetchDBShardStatus();
  ...
  modifyBalancerState() {
    ...
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.shardManagerService
          .startStopBalancer(this.selectedAutoBalancerState)
          .subscribe(
            (state: boolean) => {
              this.spinner.hide();
  ...
  private fetchBalancerState() {
    this.shardManagerService.fetchBalancerState().subscribe(
      (state: boolean) => {
        this.spinner.hide();
  ...
  private getMetadata() {
    this.shardManagerService.fetchMetadata().subscribe(
    ...
    this.shardManagerService
      ...
      .subscribe(
        (state: models.CollectionShardStatus) => {
          ...
          // this.shardKey.forEach(x => {
          //   x.bsonType = "String"; // default value
          // });
          let shardKey = '{';
  ...
  private fetchDBShardStatus() {
    this.shardManagerService
      .fetchDbShardStatus(this.selectedDatabase.database)
